...
import moodImg from "../images/mood.png";
            ...
            <main>
                ...
                <div className="main-content-text">
                    ...
                    <div className="content-list-box">
                        <img className="content-list-img" src={moodImg} alt="icon" />
                    ...
                    <div className="content-list-box">
                        <img className="content-list-img" src={activityImg} alt="icon" />
                        <div className="content-list-text">
                    ...
                    <div className="content-list-box">
                        <img className="content-list-img" src={goalImg} alt="icon" />
                        <div className="content-list-text">
                            <h3>Goal setting</h3>
